...
app.patch("/posts/:id", (req, res) => {
    ...
    const patchPost = posts[postIndex];

    patchPost.title = req.body.title || patchPost.title;
    patchPost.content = req.body.content || patchPost.content;
    patchPost.author = req.body.author || patchPost.author;
